...
export function LoginForms({ onSubmit, onChange, validate, errors }) {
  return (
...
export const VerifyEmail = ({ user, onSubmit, onChange, validate, errors, isMessage, message }) => {
  return (
    <div className="w-full h-full flex items-center justify-center">
      <form onSubmit={onSubmit} className="w-[70%] max-sm:w-[90%] max-sm:h-[80%] h-[70%] flex rounded-xl shadow-2xl bg-white max-sm:px-5 px-16 py-10 flex-col items-center justify-center">
        ...
        <div className="w-full mb-2">
          <Text text={isMessage?message+' en su bandeja de entrada':'Se ah enviado un token a su correo electronico	'} />
        </div>
        <FormsImputs
          type="text"
  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <form onSubmit={onSubmit} className="w-[70%] max-sm:w-[90%] max-sm:h-[80%] h-[70%] flex rounded-xl shadow-2xl bg-white max-sm:px-5 px-16 py-10 flex-col items-center justify-center">
        ...
        <div className="w-full mb-2">
          <SubTitle text={"Pregunta: " + user.data[0].questionKey[0].question} />
        </div>
        <div className="w-full mb-2">
